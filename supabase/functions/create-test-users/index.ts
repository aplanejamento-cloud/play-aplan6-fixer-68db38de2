...
Deno.serve(async (req) => {
  ...
  const testUsers = [
    { email: "teste1@playlike.com", password: "teste123", name: "Jogador Teste 1", user_type: "jogador", total_likes: 1000, sex: "M", whatsapp: "11999999901", birth_date: "2000-01-01", isAdmin: false },
    { email: "teste2@playlike.com", password: "teste123", name: "Jogador Teste 2", user_type: "jogador", total_likes: 800, sex: "F", whatsapp: "11999999902", birth_date: "2000-02-02", isAdmin: false },
    { email: "juiz@playlike.com", password: "teste123", name: "Juiz Teste", user_type: "juiz", total_likes: 500, sex: "M", whatsapp: "11999999903", birth_date: "1995-05-05", isAdmin: false },
