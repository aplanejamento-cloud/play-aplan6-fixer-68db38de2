...
import EliminadoStatus from "./pages/EliminadoStatus";
...
const ProtectedRoute = ({ children }: { children: React.ReactNode }) => {
  ...
  if (profile?.total_likes !== undefined && profile.total_likes <= 0 && profile.user_type === "jogador") {
    return <Navigate to="/voce-foi-eliminado" replace />;
  }
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/perfil/:username" element={<ProfileByName />} />
        <Route path="/patrocinador" element={<Patrocinador />} />
        <Route path="/eliminados" element={<Eliminados />} />
        <Route path="/voce-foi-eliminado" element={<AuthProtectedRoute><EliminadoStatus /></AuthProtectedRoute>} />
        ...
        <Route path="/admin" element={<AuthProtectedRoute><AdminStats /></AuthProtectedRoute>} />
        ...
        <Route path="/sos-ajuda" element={<Navigate to="/ajuda" replace />} />
        ...
        <Route path="/desafios" element={<ProtectedRoute><DesafiosJuiz /></ProtectedRoute>} />
        <Route path="/desafios-juiz" element={<Navigate to="/desafios" replace />} />
