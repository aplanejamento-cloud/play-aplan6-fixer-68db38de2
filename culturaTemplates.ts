...
export const CULTURA_TEMPLATES: CulturaTemplate[] = [
  ...
  { 
    id: "n1", 
    categoria: "noticias", 
    titulo: "G1: Economia Brasileira", 
    emoji: "📰", 
    texto: "📰 G1: IPCA-15 sobe 0,78% em fevereiro, puxado por educação e alimentos. 📈\n\nInflação oficial do país continua sendo monitorada de perto pelo Banco Central.\n\nLeia mais no G1: https://g1.globo.com/economia\n\n#G1 #Economia #Brasil", 
    boost: 35, 
    tags: ["#G1", "#Economia"] 
  },
  { 
    id: "n2", 
    categoria: "noticias", 
    titulo: "G1: Tecnologia e IA", 
    emoji: "🤖", 
    texto: "🤖 G1: Nova IA do Google promete revolucionar a criação de vídeos em tempo real. 🎥\n\nA tecnologia 'Veo' permite gerar clipes de alta qualidade a partir de simples textos.\n\nConfira no G1: https://g1.globo.com/tecnologia\n\n#G1 #Tecnologia #IA", 
    boost: 30, 
    tags: ["#G1", "#IA"] 
  },
  { 
    id: "n3", 
    categoria: "noticias", 
    titulo: "G1: Saúde e Bem-estar", 
    emoji: "🏥", 
    texto: "🏥 G1: Ministério da Saúde reforça campanha de vacinação contra a Dengue em todo o país. 🦟\n\nCasos aumentam e prevenção é a melhor estratégia. Cuide-se!\n\nDetalhes no G1: https://g1.globo.com/saude\n\n#G1 #Saúde #Dengue", 
    boost: 35, 
    tags: ["#G1", "#Saúde"] 
  },
  ...
  { id: "fi4", categoria: "noticias", titulo: "G1 Notícias", emoji: "📰", texto: "📰 NOTÍCIAS DO DIA - G1!\n\nhttps://g1.globo.com\n\nFique por dentro de tudo! 🌍\nQual notícia te surpreendeu?\n\n#G1 #Notícias #Brasil", boost: 20, tags: ["#G1", "#Notícias"] },
];
