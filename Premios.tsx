  ...
  return (
    <div className="flex-shrink-0 w-[300px] rounded-2xl overflow-hidden border border-border bg-card shadow-lg flex flex-col">
      ...
      <div className="flex-1 p-4 flex flex-col gap-2">
        {isFinalistOnly && (
          <Badge className="bg-accent text-accent-foreground text-xs mb-1">🏆 Somente Para Finalistas</Badge>
        )}
        ...
        {isFinalistOnly ? (
          <p className="text-xs text-muted-foreground">Qtd:1 unidade | Somente Para Finalistas | Estoque:1</p>
        ) : (
          <>
